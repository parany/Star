starApp.controller('addTreatyController', ['$scope', '$routeParams', '$location', 'starTable', 'genericService', function($scope, $routeParams, $location, starTable, genericService) {
