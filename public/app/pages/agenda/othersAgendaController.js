angular.module('starApp.controllers').controller('othersAgendaController', ['$scope', '$location', 'genericService', 'activityService', 'starTable', function($scope, $location, genericService, activityService, starTable) {
